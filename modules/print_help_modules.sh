...
print_modules(){
   ...
   echo -e "$red   ├ $green web/fingerprint       ${red}➤       ${white}Fingerprint [server,waf,cms,etc..]"    
   echo -e "$red   ├ $green web/attack            ${red}➤       ${white}Attacks [sql,ldap,injection,etc..]"    
   echo -e "$red   ├ $green web/audit             ${red}➤       ${white}Audit [phpinfo,openredirect,etc..] "    
   echo -e "$red   ├ $green web/dsisclosure       ${red}➤       ${white}Disclosure [emails,password,etc..]"           
   echo -e "$red   ├ $green web/fullscan          ${red}➤       ${white}Full scan [audit,attack,dirscan..]"           
   echo -e "$red   ├"
